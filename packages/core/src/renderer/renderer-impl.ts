...
export function initRendererServer(opts: IOpts = {}): RendererAPI & { parse: (md: string) => string } {
  ...
  return {
    ...
    getOpts,
    parse: (md: string) => instance.parse(md) as string,
  }
}
